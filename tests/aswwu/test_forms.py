...
def test_view_all_jobs(testing_server, jobsdb_conn):
    with job_posting(jobsdb_conn, None), job_question(jobsdb_conn, None):
        expected_data = {"image": "", "visibility": False, "jobID": 1,
                         "job_description": "Doesn't Really Matter", "department": None, "job_name": "ASWWU Generic"}
